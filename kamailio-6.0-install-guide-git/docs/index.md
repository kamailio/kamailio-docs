# Kamailio v6.0 - Install Guide #

**Guide to install Kamailio SIP Server v6.0 (stable) from Git repository.**
...
server 6.0.x version using the sources downloaded from GIT repository -
...
*This document focuses on Kamailio v6.0.x series with MySQL/MariaDB support, using a Debian unstable system.*
...
You can browse [kamailio.cfg](https://github.com/kamailio/kamailio/blob/6.0/etc/kamailio.cfg)
